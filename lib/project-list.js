export const projects = [
  ...
  {
    name: 'React Notes CRUD',
    image: 'notes.png',
    tags: ['React', 'Node.js', 'MongoDB', 'JWT'],
    description: `Users can register, login and create, edit and delete Notes. MongoDB for data persistance and JSON Web Token for authentication.`,
    codeLink: 'https://github.com/EzequielCaste/react-notes',
    demoLink: 'https://react-notes-navy.vercel.app/',
  },
  {
    name: 'DevJobs',
    image: 'devjobs.png',
    tags: ['Next.JS', 'SASS', 'CSS Modules', 'Node-fetch'],
    description: `Search and fetch jobs from the GitHub Jobs API. `,
